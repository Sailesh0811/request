...
<body>
	<table class="responsive-table">
      ...
      <button class="btn waves-effect waves-light center blue accent-4" type="button" id="delete" name="action">Delete
        <i class="material-icons right">send</i>
      </button>
       <button class="btn waves-effect waves-light center blue accent-4" type="button" id="session" name="action">Session
        <i class="material-icons right">send</i>
      </button>
      </div>
